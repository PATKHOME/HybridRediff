...
public class ZipAndSendMail
{
	...
	static String[] toEmails = { "pktest3cp@gmail.com","pattestakung@yahoo.com" };
	static String fromUser = "pktest3cp";//just the id alone without @gmail.com
	static String password = "pk3testcp";
